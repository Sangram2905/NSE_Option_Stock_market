...
class NseOI:
    ...
    def about(self, event=None):
        ...
        dev_val = Label(self.info, text="Credit to Varun Shanbhag for bacse program", fg="blue", cursor="hand2", relief=RIDGE)
    ...
    def main_win(self):
        ...
        oi_ub_label = Label(bottom_frame, text="Max Open Interest", relief=RIDGE,
        ...
        oi_lb_label = Label(bottom_frame, text="Min Open Interest", relief=RIDGE,
                            font=("TkDefaultFont", 10, "bold"))
    ...
    def main(self):
        ...
        self.root.after((self.seconds * 450), self.main)
        return
